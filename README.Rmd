...
```
Both of these genes seem to be non-expressed though PRKCG managed to be just above the removal threshold. Luckyly lack of correlation reveals that it is not behaving as other marker genes.
